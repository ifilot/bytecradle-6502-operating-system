...
POUT1:
    lDA #'|'		        ; print vert edge
    JSR putch	            ; PRINT ONE ASCII CHR - SPACE
    LDX #$1F
POUT2:
...
POUT9:
    LDA #$0D
    JSR putch	            ; PRINT ONE ASCII CHR - CR
    LDA #$0A
    JSR putch	            ; PRINT ONE ASCII CHR - LF
    RTS
